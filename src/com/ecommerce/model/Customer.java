...
public class Customer {
    ...
    public boolean equals(Object o) {
        ...
        return id == customer.id && age == customer.age && Objects.equals(name, customer.name) && Objects.equals(email, customer.email) && Objects.equals(gender, customer.gender) && Objects.equals(status, customer.status) && Objects.equals(membershipType, customer.membershipType) && Objects.equals(resdentialAddress, customer.resdentialAddress) && Objects.equals(shippingAddress, customer.shippingAddress);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, email, age, gender, status, membershipType, resdentialAddress, shippingAddress);
    }
